...
export default function ResultsScreen() {
	const { questions, confirmedAnswers, resetQuiz, correctCount } =
		useQuizStore();
			...
			<div className="bg-graphite border border-charcoal-grey rounded-cards p-6 text-center shadow-sm">
				...
				<div className="flex justify-center gap-4">
					<div className="text-center">
						<div className="text-heading font-w590 text-emerald">
							{correctAnswers}
						</div>
					...
					<div className="text-center">
						<div className="text-heading font-w590 text-warning-red">
							{incorrectAnswers}
						</div>
